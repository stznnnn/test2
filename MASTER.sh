...
# Добавляем Prometheus в автозагрузку Grafana (минимальная настройка)
echo "Настройка Grafana для работы с Prometheus..."
...
# Создаем БД и таблицу с данными компании
...
# Создаем простой сайт с кнопкой для вывода данных
...
# PHP-скрипт для получения данных из БД
...
# Настраиваем виртуальный хост для mopc.com
...
# Добавляем запись в /etc/hosts для тестирования
...
4. Сайт доступен: http://mopc.com
   - Нажмите кнопку для вывода данных из БД.
